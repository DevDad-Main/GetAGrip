...
use getagrip_core::session::{ConnectionDriver, ConnectionProfile};
...
impl ConnectionManager {
    ...
    pub async fn disconnect(&self, profile_id: Id<getagrip_core::session::ConnectionProfileId>) {
    ...
    pub fn get(&self, profile_id: Id<getagrip_core::session::ConnectionProfileId>) -> Option<ManagedConnection> {
...
mod tests {
    use super::*;
    use getagrip_core::session::ConnectionProfile;
